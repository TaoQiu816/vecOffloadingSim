...
## Tail Summary
- lr_c=2e-4: reward_mean=0.0097, reward_total=0.2001, task_sr=0.8850, deadline_miss=0.1135, avg_rsu_queue=1.1522
...
## Visual Takeaways
- Highest tail task success rate: lr_c=3e-4
- Lowest tail deadline miss rate: lr_c=3e-4
- Highest tail average reward: lr_c=3e-4
- Highest tail total reward: lr_c=3e-4
